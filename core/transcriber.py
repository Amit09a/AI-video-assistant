...
def transcribe_chunk_sarvam(chunk_path: str) -> str:
    ...
    We split this chunk into 25-second pieces,
    send each separately, and join the transcripts.
    """

    audio = AudioSegment.from_wav(chunk_path) # detect the audio type of files automatically 

    piece_ms = SARVAM_PIECE_SECONDS * 1000 # converted to ms
...
def transcribe_chunk(
    ...
    - hinglish → Sarvam (translates to English)
    """
